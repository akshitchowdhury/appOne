    ...
    steps: [
      ...
      },
      {
        ...
        lines: [
          ...
          gap(),
          cmt("# Recheck needs to be done to ensure Nginx comes back up automatically after a reboot "),
          cmd('sudo systemctl enable nginx'),
          gap(),
          cmt('# curl the public IP and see if we get back the HTML'),
          cmd('curl http://100.31.139.37/'),
        ],
      },
    ],
  },
